...
class instances: # the class of a analyzed sentence
	...
	def __init__(self):
		...
		self.testLabel = None # the label for accuracy test, could be a top x judgement.
		self.featureVec = None # the composite feature vector for this instance, for training use
		return
